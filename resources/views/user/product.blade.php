    ...
    <div class="container my-5">
        ...
        @auth
            @if (auth()->user()->role == 'admin')
                <div class="mb-3">
                    <a href="#" class="btn" style="background-color:#034f84; border-color:white; color:white" data-bs-toggle="modal" data-bs-target="#add_product">Add
                        Product</a>
                </div>
                        ...
                        <div class="modal-content">
                            ...
                            <form action="/my/dashboard/add-product" method="POST" id="add-product-form"
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                    <div class="col-md-5">
                                    <img id="preview-image" src="{{ asset('images/' . ($product->image ?? 'no-image.jpg')) }}" alt="no-image" width="100%" class="mb-4">
                                    <input class="form-control mt-5" type="file" id="formFile" accept="image/jpeg, image/jpg, image/png" name="image">
                                        ...
                                        <div class="col-md-7">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" id="category" name="category">
                                                    ...
                                                    <option value="SarungCover">SarungCover</option>
                                                </select>
                                            </div>
                                            <div class="mb-3">
                                ...
                                <div class="modal-footer">
                                    <button type="submit" class="btn" style="background-color:#034f84; border-color:white; color:white">Add Product</button>
                                </div>
                            </form>
                        </div>
                    </div>
