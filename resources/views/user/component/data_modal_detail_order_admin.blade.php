        ...
        <table class="table table-striped">
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="/images/my/pembayaran/{{ $data->bukti_pembayaran }}" target="_blank"><img src="/images/my/pembayaran/{{ $data->bukti_pembayaran }}" alt="no-photo" class="w-100"></a>
                    </td>
                </tr>
                <tr>
...
<div class="row">
    <div class="col-12 mb-3 d-flex justify-content-center">
        <div class="frame-photo border border-3 border-primary rounded-4">
